...
def gameFrame(): # MAKE YOUR GAME IN THIS FUNCTIONS (will be called every frame)
    ...
    if once:
        ...
        bs1 = object({ #battleship
            ...
            "#00fff2": [[-1,1],[1,1],[-1,2],[1,2]] #boosters
            },
            {
                "z_value": 5,
                "pos": [10,37],
        ...
        line = lineObj([0,4],[20,4], "#7a0000", 1, True)
        line1 = txtObj("HEHE",[2,6],"#ff8cea",2,True)
        text = txtObj(str(life), [2,12], "#ff8cea", 2, True)
        black = rectangleObj([0,0], [20,3], "#030303", 5, True)
        ...
        if countm ==15:
            ...
            if flagc ==1 :
                ...
                flagc = 0
                objArr.pop(Index)
                text = txtObj(str(life), [2,12], "#ff8cea", 10, True)
                objArr.append(text)
                Index = len(objArr)-1
        if getKeyState("A"):
            offset(bs1, [-1,0])
      ...
      # ↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓SHOT DOWN↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓
        if(bul1.curr_pos[1]-obj2.curr_pos[1]>=0 and obj2.curr_pos[1]-bul1.curr_pos[1] <5 and bul1.curr_pos[0]==obj2.curr_pos[0]) :
            offset(bul1, [bs1.curr_pos[0]-bul1.curr_pos[0],bs1.curr_pos[1]-bul1.curr_pos[1]-3])
            offset(obj2, [0, -36])
            if obj2.curr_pos[0]<=10:
                ran = random.randint(0,10)
        ...
        if(bul1.curr_pos[1]-obj3.curr_pos[1]>=0 and obj3.curr_pos[1]-bul1.curr_pos[1] <5 and bul1.curr_pos[0]==obj3.curr_pos[0]) :
            offset(bul1, [bs1.curr_pos[0]-bul1.curr_pos[0],bs1.curr_pos[1]-bul1.curr_pos[1]-3])
            offset(obj3, [0, -36])
            if obj3.curr_pos[0]<=10:
                ran = random.randint(0,10)
        ...
        if(bul1.curr_pos[1]-obj4.curr_pos[1]>=0 and obj4.curr_pos[1]-bul1.curr_pos[1] <5 and bul1.curr_pos[0]==obj4.curr_pos[0]) :
            offset(bul1, [bs1.curr_pos[0]-bul1.curr_pos[0],bs1.curr_pos[1]-bul1.curr_pos[1]-3])
            offset(obj4, [0, -36])
            if obj4.curr_pos[0]<=10:
                ran = random.randint(0,10)
        ...
        if(bul1.curr_pos[1]-obj5.curr_pos[1]>=0 and obj5.curr_pos[1]-bul1.curr_pos[1] <5 and bul1.curr_pos[0]==obj5.curr_pos[0]) :
            offset(bul1, [bs1.curr_pos[0]-bul1.curr_pos[0],bs1.curr_pos[1]-bul1.curr_pos[1]-3])
            offset(obj5, [0, -36])
            if obj5.curr_pos[0]<=10:
                ran = random.randint(0,10)
        ...
        if(bul1.curr_pos[1]-obj6.curr_pos[1]>=0 and obj6.curr_pos[1]-bul1.curr_pos[1] <5 and bul1.curr_pos[0]==obj6.curr_pos[0]) :
            offset(bul1, [bs1.curr_pos[0]-bul1.curr_pos[0],bs1.curr_pos[1]-bul1.curr_pos[1]-3])
            offset(obj6, [0, -36])
            if obj6.curr_pos[0]<=10:
                ran = random.randint(0,10)
        ...
        if(bul2.curr_pos[1]-obj2.curr_pos[1]>=0 and obj2.curr_pos[1]-bul2.curr_pos[1] <5 and bul2.curr_pos[0]==obj2.curr_pos[0]) :
            offset(bul2, [bs1.curr_pos[0]-bul2.curr_pos[0],bs1.curr_pos[1]-bul2.curr_pos[1]-3])
            offset(obj2, [0, -36])
            if obj2.curr_pos[0]<=10:
                ran = random.randint(0,10)
        ...
        if(bul2.curr_pos[1]-obj3.curr_pos[1]>=0 and obj3.curr_pos[1]-bul2.curr_pos[1] <5 and bul2.curr_pos[0]==obj3.curr_pos[0]) :
            offset(bul2, [bs1.curr_pos[0]-bul2.curr_pos[0],bs1.curr_pos[1]-bul2.curr_pos[1]-3])
            offset(obj3, [0, -36])
            if obj3.curr_pos[0]<=10:
                ran = random.randint(0,10)
        ...
        if(bul2.curr_pos[1]-obj4.curr_pos[1]>=0 and obj4.curr_pos[1]-bul2.curr_pos[1] <5 and bul2.curr_pos[0]==obj4.curr_pos[0]) :
            offset(bul2, [bs1.curr_pos[0]-bul2.curr_pos[0],bs1.curr_pos[1]-bul2.curr_pos[1]-3])
            offset(obj4, [0, -36])
            if obj4.curr_pos[0]<=10:
                ran = random.randint(0,10)
        ...
        if(bul2.curr_pos[1]-obj5.curr_pos[1]>=0 and obj5.curr_pos[1]-bul2.curr_pos[1] <5 and bul2.curr_pos[0]==obj5.curr_pos[0]) :
            offset(bul2, [bs1.curr_pos[0]-bul2.curr_pos[0],bs1.curr_pos[1]-bul2.curr_pos[1]-3])
            offset(obj5, [0, -36])
            if obj5.curr_pos[0]<=10:
                ran = random.randint(0,10)
        ...
        if(bul2.curr_pos[1]-obj6.curr_pos[1]>=0 and obj6.curr_pos[1]-bul2.curr_pos[1] <5 and bul2.curr_pos[0]==obj6.curr_pos[0]) :
            offset(bul2, [bs1.curr_pos[0]-bul2.curr_pos[0],bs1.curr_pos[1]-bul2.curr_pos[1]-3])
            offset(obj6, [0, -36])
            if obj6.curr_pos[0]<=10:
                ran = random.randint(0,10)
        ...
        if(bul3.curr_pos[1]-obj2.curr_pos[1]>=0 and obj2.curr_pos[1]-bul3.curr_pos[1] <5 and bul3.curr_pos[0]==obj2.curr_pos[0]) :
            offset(bul3, [bs1.curr_pos[0]-bul3.curr_pos[0],bs1.curr_pos[1]-bul3.curr_pos[1]-3])
            offset(obj2, [0, -36])
            if obj2.curr_pos[0]<=10:
                ran = random.randint(0,10)
        ...
        if(bul3.curr_pos[1]-obj3.curr_pos[1]>=0 and obj3.curr_pos[1]-bul3.curr_pos[1] <5 and bul3.curr_pos[0]==obj3.curr_pos[0]) :
            offset(bul3, [bs1.curr_pos[0]-bul3.curr_pos[0],bs1.curr_pos[1]-bul3.curr_pos[1]-3])
            offset(obj3, [0, -36])
            if obj3.curr_pos[0]<=10:
                ran = random.randint(0,10)
        ...
        if(bul3.curr_pos[1]-obj4.curr_pos[1]>=0 and obj4.curr_pos[1]-bul3.curr_pos[1] <5 and bul3.curr_pos[0]==obj4.curr_pos[0]) :
            offset(bul3, [bs1.curr_pos[0]-bul3.curr_pos[0],bs1.curr_pos[1]-bul3.curr_pos[1]-3])
            offset(obj4, [0, -36])
            if obj4.curr_pos[0]<=10:
                ran = random.randint(0,10)
        ...
        if(bul3.curr_pos[1]-obj5.curr_pos[1]>=0 and obj5.curr_pos[1]-bul3.curr_pos[1] <5 and bul3.curr_pos[0]==obj5.curr_pos[0]) :
            offset(bul3, [bs1.curr_pos[0]-bul3.curr_pos[0],bs1.curr_pos[1]-bul3.curr_pos[1]-3])
            offset(obj5, [0, -36])
            if obj5.curr_pos[0]<=10:
                ran = random.randint(0,10)
        ...
        if(bul3.curr_pos[1]-obj6.curr_pos[1]>=0 and obj6.curr_pos[1]-bul3.curr_pos[1] <5 and bul3.curr_pos[0]==obj6.curr_pos[0]) :
            offset(bul3, [bs1.curr_pos[0]-bul3.curr_pos[0],bs1.curr_pos[1]-bul3.curr_pos[1]-3])
            offset(obj6, [0, -36])
            if obj6.curr_pos[0]<=10:
                ran = random.randint(0,10)
